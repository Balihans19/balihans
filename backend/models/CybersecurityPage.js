...
//  schema for the cybersecuritypage
const cybersecuritypageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'CybersecurityPage' });

// Export the model
module.exports = mongoose.model('CybersecurityPage', cybersecuritypageSchema);