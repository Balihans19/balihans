...
//  schema for the cloudandinfrastructurepage
const cloudandinfrastructurepageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'CloudAndInfrastructurePage' });

// Export the model
module.exports = mongoose.model('CloudAndInfrastructurePage', cloudandinfrastructurepageSchema);