...
//  schema for the testingservicespage
const testingservicespageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'TestingServicesPage' });

// Export the model
module.exports = mongoose.model('TestingServicesPage', testingservicespageSchema);