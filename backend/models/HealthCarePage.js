...
//  schema for the healthcarepage
const healthcarepageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'HealthCarePage' });

// Export the model
module.exports = mongoose.model('HealthCarePage', healthcarepageSchema);
