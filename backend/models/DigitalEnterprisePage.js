...
//  schema for the digitalenterprisepage
const digitalenterprisepageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'DigitalEnterprisePage' });

// Export the model
module.exports = mongoose.model('DigitalEnterprisePage', digitalenterprisepageSchema);