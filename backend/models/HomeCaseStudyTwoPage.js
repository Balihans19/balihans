...
const homecasestudytwopageSchema = new mongoose.Schema({
...
}, { collection: 'HomeCaseStudyTwoPage' });

// Export the model
module.exports = mongoose.model('HomeCaseStudyTwoPage', homecasestudytwopageSchema);