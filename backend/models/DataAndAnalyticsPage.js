...
//  schema for the dataandanalyticspage
const dataandanalyticspageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'DataAndAnalyticsPage' });

// Export the model
module.exports = mongoose.model('DataAndAnalyticsPage', dataandanalyticspageSchema);