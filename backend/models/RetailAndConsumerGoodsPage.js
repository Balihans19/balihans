...
//  schema for the retailandconsumergoodspage
const retailandconsumergoodspageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'RetailAndConsumerGoodsPage' });

// Export the model
module.exports = mongoose.model('RetailAndConsumerGoodsPage', retailandconsumergoodspageSchema);
