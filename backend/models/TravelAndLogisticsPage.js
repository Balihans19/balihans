...
//  schema for the travelandlogisticspage
const travelandlogisticspageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'TravelAndLogisticsPage' });

// Export the model
module.exports = mongoose.model('TravelAndLogisticsPage', travelandlogisticspageSchema);
