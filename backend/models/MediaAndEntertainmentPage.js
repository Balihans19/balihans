...
//  schema for the mediaandentertainmentpage
const mediaandentertainmentpageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'MediaAndEntertainmentPage' });

// Export the model
module.exports = mongoose.model('MediaAndEntertainmentPage', mediaandentertainmentpageSchema);
