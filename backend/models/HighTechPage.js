...
//  schema for the hightechpage
const hightechpageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'HighTechPage' });

// Export the model
module.exports = mongoose.model('HighTechPage', hightechpageSchema);
