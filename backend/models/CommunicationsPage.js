...
//  schema for the communicationspage
const communicationspageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'CommunicationsPage' });

// Export the model
module.exports = mongoose.model('CommunicationsPage', communicationspageSchema);