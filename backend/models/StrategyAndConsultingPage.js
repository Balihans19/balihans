...
//  schema for the strategyandconsultingpage
const strategyandconsultingpageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'StrategyAndConsultingPage' });

// Export the model
module.exports = mongoose.model('StrategyAndConsultingPage', strategyandconsultingpageSchema);