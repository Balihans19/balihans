...
//  schema for the professionalservicespage
const professionalservicespageSchema = new mongoose.Schema({
  videoData: [{
...
}, { collection: 'ProfessionalServicesPage' });

// Export the model
module.exports = mongoose.model('ProfessionalServicesPage', professionalservicespageSchema);
