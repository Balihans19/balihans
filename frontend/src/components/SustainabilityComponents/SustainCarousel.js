    ...
    return (
      <div className="w-full max-w-7xl mx-auto px-4 my-36">
        ...
        <div className="relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute -left-32 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center bg-gray-200 rounded-full shadow z-10"
          ...
          <button
            onClick={nextSlide}
            className="absolute -right-32 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center bg-gray-200 rounded-full shadow z-10"
