...
const LeaderShipRole = ({ leadershipData }) => {
  ...
  return (
    <div className="min-h-screen py-8 sm:py-12 md:py-44 px-0 lg:px-24">
      {/* Header Section */}
      <div className="max-w-lg sm:max-w-xl md:max-w-4xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-7xl mx-8 lg:mx-auto 2xl:mx-48 mt-10 lg:mt-0">
        ...
        <div className="relative flex flex-col items-center">
          ...
          {isDesktop && (
            <>
              <button
                ...
                className="hidden lg:block absolute -left-24 xl:-left-20 2xl:-left-28 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 sm:p-3 shadow-lg hover:bg-gray-100 transition-colors duration-300"
              >
                <ArrowLeft size={24} />
              </button>
              ...
              <button
                onClick={handleNext}
                className="hidden lg:block absolute -right-24 xl:-right-20 2xl:-right-36 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 sm:p-3 shadow-lg hover:bg-gray-100 transition-colors duration-300"
              >
                <ArrowRight size={24} />
              </button>
            </>
          ...
          <div className="hidden lg:grid grid-cols-[40%_5%_50%] xl:grid-cols-[30%_5%_60%] gap-8 lg:gap-6 xl:gap-12 w-full">
            ...
            {/* Profile Info Column */}
            <div className="flex flex-col justify-start space-y-6 sm:space-y-4 overflow-auto max-h-[600px] pr-4"
            style={{
                scrollbarWidth: 'none', 
