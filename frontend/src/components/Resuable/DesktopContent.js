...
const styles = {
  // About Us section
  aboutCustomer: {
    backgroundImage: 'url("https://res.cloudinary.com/dnijlfi48/image/upload/v1730886860/Untitled_design_31_ludy13.png")',
  ...
  aboutFaster: {
    backgroundImage: 'url("https://res.cloudinary.com/dnijlfi48/image/upload/v1730886938/Untitled_design_32_moqp7n.png")',
    backgroundSize: 'cover',
    backgroundPosition: 'center',
    backgroundRepeat: 'no-repeat'
  },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-5xl mx-auto px-4 text-white">
          ...
          <div className="w-full min-w-[200px] my-4 md:my-8">
            ...
            <ul className="list-none text-base lg:text-lg p-0">
              ...
              <li className="mb-2">Corporate Sustainability</li>
            </ul>
          </div>

          <div className="w-full min-w-[200px] my-4 md:my-8">
            <ul className="list-none text-base lg:text-lg p-0">
              <li className="mb-2">Diversity, Equity, and Inclusion</li>
          ...
          <div className="w-full">
            <div style={styles.aboutCustomer} className="min-h-[200px] lg:min-h-[250px] text-center p-4 lg:pl-10 bg-black bg-opacity-80">
    ...
    },
    {
      ...
      content: (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-5xl mx-auto px-4 text-white">
          ...
          <div className="w-full min-w-[200px]">
            <ul className="list-none text-base lg:text-lg p-0 mt-12">
