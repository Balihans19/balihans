          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <img
                  src="https://res.cloudinary.com/dnijlfi48/image/upload/v1730886548/Untitled_design_20_uqhti3.png"
                  alt="E-commerce"
              ...
              <div className="relative">
                <img
                  src="https://res.cloudinary.com/dnijlfi48/image/upload/v1730886548/Untitled_design_30_xuetna.png"
                  alt="Insurance"
                  className="w-[20vh] lg:w-[25vh] h-32 object-cover"
                />
...
<div className="mt-10 border-t border-gray-700 pt-6">
  ...
  <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[20%_20%_60%] gap-y-6 items-center">
    
    {/* Column 1: Logo */}
    <div className="text-left">
      <img src="https://res.cloudinary.com/dbmwkp9a9/image/upload/v1729842945/Balihans_-_logo_off-white_semxwr.png" alt="Balihans Logo" className="w-36  md:mx-0" />
    </div>
