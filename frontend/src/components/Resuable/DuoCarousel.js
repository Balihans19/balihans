...
const DuoCarousel = ({ slides, title }) => {
  ...
  const handleSlideClick = (slide) => {
    if (slide.link) {
      navigate(slide.link); // Navigate to the slide's specific link
    }
  };
          ...
          <div className="overflow-hidden relative">
            ...
            >
              {slides.map((slide, index) => (
                <div
                  key={index}
                  className="w-1/2 flex-shrink-0 px-4 md:px-10 flex flex-col items-center cursor-pointer"
...
//     <div className="w-full bg-[#f8f9fa]">
//       <div className="max-w-4xl xl:max-w-6xl mx-auto px-4 py-28">
//         <h1 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-24">{title}</h1>
//         <div className="relative">
//           <div className="overflow-hidden relative">
//             <div
//               className="flex transition-transform ease-out duration-1000"
...
//                 <div
//                   key={index}
//                   className="w-1/2 flex-shrink-0 px-4 md:px-10 flex flex-col items-center"
//                 >
//                   <div className="relative aspect-w-4 aspect-h-3 overflow-hidden group w-full">
//                     <img
//                       src={slide.image}
