 ...
 * - Dynamic backend status checking for submission availability
 */
...
const SubmitResume = () => {
  ...
  if (isLoadingStatus) {
    return (
      <div className="relative min-h-screen lg:min-h-[850px] text-white w-full pb-24 mt-12 lg:mt-0 flex items-center justify-center">
        <div 
          ...
          <div className="flex flex-col w-full max-w-xl 2xl:max-w-3xl p-6 rounded-md relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
             ...
             <div>
              ...
              {/* Submit button with loading state and dynamic enable/disable */}
              <div>
                <button
                  type="submit"
