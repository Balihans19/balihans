  ...
  return (
    <div className="min-h-screen text-white py-24 lg:py-24 px-6 lg:px-32 rounded-lg flex flex-col lg:flex-row gap-10 items-center justify-center max-w-full mx-auto">
      ...
      <div className="w-full lg:w-[70%] text-center lg:text-left">
        {/* Quote Image */}
        <img src={quoteImageUrl} alt="Quote" className="w-[100px] h-[80px] text-gray-400 text-5xl lg:text-8xl mb-16" />
        ...
        <div className="mt-10 border-t border-gray-700 pt-4">
          ...
          <p className="text-gray-400 text-2xl">Head of AI, Balihans</p>
        </div>
      </div>
    </div>
  );
